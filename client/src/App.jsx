  ...
  return (
    <div>
      ...
      <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-teal-500 from-blue-700">Automated Summarizer</span> </h1>
        <p class="text-3xl font-extrabold text-gray-500 lg:text-3xl dark:text-black"> <span class="text-transparent bg-clip-text bg-gradient-to-r to-teal-500 from-blue-700">  And Q&A for Articles </span></p>
      ...
      <div className="p-8 bg-white rounded-lg w-full max-w-xl transform hover:scale-105 transition-transform duration-300">
        ...
        {summary && (
          <div className="mt-6 p-4 bg-gray-100 border border-gray-300 rounded-lg shadow-md w-full max-w-screen-lg">
            <p className="text-sm font-normal mb-2 whitespace-pre-line"><b>Summary : </b> <br/> 
            {
              <p dangerouslySetInnerHTML={{ __html: summary.replace(/\*\*(.*?)\*\*/g, '<b>$1</b>') }} />
              // summary.replace(/\n/g, "<br/>")
            }
