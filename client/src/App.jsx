...
const App = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200">
      ...
      {/* Form without a white background */}
      <form
        onSubmit={handleSubmit}
        className="flex flex-col items-center w-full max-w-xl p-8 transform hover:scale-105 transition-transform duration-300"
      >
        <label
          htmlFor="url"
        ...
        <div className="flex items-center w-full mb-2">
          <input
            ...
            className="flex-grow px-4 py-2 border rounded-l-md focus:outline-none focus:ring focus:border-blue-300 bg-white"
      ...
      {isLoading && (
        <div className="mt-2 text-blue-600 animate-pulse">
          Processing...
        </div>
      )}
